...
const char *from_list[] = {"/smart_home/temp/from/","/smart_home/hum/from/", "/smart_home/time/from/", "/smart_home/wireless_lamp/from/",
                      "/smart_home/ir_lamp/from/", "/smart_home/wire_lamp/from/", "/smart_home/led_lenta/from/"};

const char *to_list[] = {"/smart_home/temp/to","/smart_home/hum/to", "/smart_home/time/to", "/smart_home/wireless_lamp/to",
                      "/smart_home/ir_lamp/to", "/smart_home/wire_lamp/to", "/smart_home/led_lenta/to"};
...
void onMqttMessage(char *topic, char *payload, AsyncMqttClientMessageProperties properties, size_t len, size_t index, size_t total)
{
  ...
  if (!strcmp("/smart_home/wire_lamp/to/", topic))
  {
    int st = atoi(payload);
    Serial.printf("Value = %d\n", st);
